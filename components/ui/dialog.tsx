  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-full border border-stone-200 p-2 text-stone-500 transition hover:bg-stone-50 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2"
        type="button"
      >
        <X className="h-4 w-4" />
